...
build: ## Builds the starter pack
	go build -i github.com/huangjiuyuan/helm-broker/cmd/servicebroker
...
linux: ## Builds a Linux executable
	...
	go build -o servicebroker-linux --ldflags="-s" github.com/huangjiuyuan/helm-broker/cmd/servicebroker
